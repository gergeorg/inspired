			...
			<Container>
				<div className={style.container}>
					...
					<div className={style.social}>
						<h2 className={cn(style.title, style.categoryTitle)}>Связаться с нами</h2>
						<p className={style.socialTitle}>Контакты и адреса магазинов</p>

						<ul className={style.socialList}>
							<li>
								<a href='#' className={cn(style.link, style.socialLinkVK)} aria-label='Связаться с нами в социальной сети vk.com'>
							...
							<li>
								<a href='#' className={cn(style.link, style.socialLinkFB)} aria-label='Связаться с нами в социальной сети facebook.com'>
									<svg width='24' height='24' viewBox='0 0 24 24' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
